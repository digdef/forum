...
class News{
	...
	public function news(){
		...
		$result = mysqli_query($connection,"SELECT COUNT(`id`) AS `posts` FROM `news`"); 
		...
		$articles = mysqli_query($connection, "SELECT * FROM `news` ORDER BY `id` DESC LIMIT $start, $num");
