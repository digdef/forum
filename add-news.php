...
<body>
	...
	<form style="text-align: center;" method="POST" action="add-news.php">
		<?php $add_news = new add_news(); ?><br>
		...
		<label style="font-size: 25px;">img(Ссылка)</label><br>
		<input class="box-login" type="text" name="img"><br>
		<label style="font-size: 25px;">Категория</label><br>
		<?php $add_categories = new add_categories('categories');?><br>
	...
	<script type="text/javascript" src="lib/editor/ckeditor.js"></script>
</body>
<script>
